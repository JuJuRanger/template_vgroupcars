...
$factory->define(Purchasecar::class, function (Faker $faker) {
    return [
        ...
        'purchasecar_downpayment' => $faker->randomFloat($nbMaxDecimals = -4, $min = 50000, $max = 400000),
        'purchasecar_payment' => $faker->numberBetween($min = 5000, $max = 30000),
        'purchasecar_carprice' => $faker->randomFloat($nbMaxDecimals = -5, $min = 500000, $max = 2000000),
